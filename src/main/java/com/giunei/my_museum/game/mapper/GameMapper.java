...
public class GameMapper {
    ...
    public GameResponse toSearchResponse(RawgGameResponse.RawgGameItem item) {
        return toSearchResponse(item, null);
    }

    public GameResponse toSearchResponse(RawgGameResponse.RawgGameItem item, UserCollectionInfo userCollectionInfo) {
        return new GameResponse(
                ...
                rawgStoreService.resolveEmbeddedStores(item),
                userCollectionInfo
        );
    }
