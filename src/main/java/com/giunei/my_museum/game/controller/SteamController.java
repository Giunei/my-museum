...
import com.giunei.my_museum.game.dto.ConnectSteamRequest;
import com.giunei.my_museum.game.dto.SteamConnectionStatusResponse;
import com.giunei.my_museum.game.dto.SteamSyncStatusResponse;
import com.giunei.my_museum.game.dto.SteamSummaryResponse;
import com.giunei.my_museum.game.service.SteamAuthService;
import com.giunei.my_museum.game.service.SteamService;
import com.giunei.my_museum.game.service.SteamSyncService;
import com.giunei.my_museum.game.service.SteamSyncStatusService;
...
public class SteamController {
    ...
    @GetMapping({"/callback", "/callback/{state}"})
    public ResponseEntity<Void> handleCallback(
            @PathVariable(required = false) String state,
            @RequestParam Map<String, String> params
    ) {
        String redirectUrl = steamAuthService.handleCallback(state, params);
