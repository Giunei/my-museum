package com.giunei.my_museum.movie.catalog.service;

import com.giunei.my_museum.common.config.CacheManagers;
import com.giunei.my_museum.movie.catalog.repository.MovieCatalogRepository;
...
public class MovieCatalogService {
    ...
    @Cacheable(cacheManager = CacheManagers.RECOMMENDATION, value = "movie-recommendation-catalog")
